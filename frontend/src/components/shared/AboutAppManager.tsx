...
export const AboutAppManager: React.FC<Props> = ({ themeColor }) => {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24, maxWidth: 960, margin: '0 auto' }}>
      {/* Hero Header */}
      <div style={{ background: `linear-gradient(135deg, ${themeColor} 0%, #0F172A 100%)`, color: 'var(--text-inverse)', padding: 36, borderRadius: 16, boxShadow: '0 10px 25px -5px rgba(0,0,0,0.1)' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>
        ...
        <div style={{ background: 'var(--bg-card)', padding: 24, borderRadius: 14, border: '1px solid var(--border-color)', display: 'flex', flexDirection: 'column', gap: 14 }}>
          <h3 style={{ margin: '0 0 4px 0', fontSize: '1.05rem', fontWeight: 800, color: 'var(--text-main)', display: 'flex', alignItems: 'center', gap: 8 }}>
            👨‍💻 Éditeur & Conception Technologique
          </h3>

          <div style={{ display: 'flex', flexDirection: 'column', gap: 10, fontSize: '0.88rem', color: 'var(--text-muted)' }}>
            <div>
              <strong style={{ color: 'var(--text-muted)', fontSize: '0.75rem', display: 'block' }}>SOCIÉTÉ ÉDITRICE</strong>
              <span style={{ fontWeight: 800, color: themeColor, fontSize: '1.05rem' }}>KPSy Informatique</span>
            </div>

            <div>
              <strong style={{ color: 'var(--text-muted)', fontSize: '0.75rem', display: 'block' }}>CONCEPTEUR & DÉVELOPPEUR PRINCIPAL</strong>
              <span style={{ fontWeight: 800, color: 'var(--text-main)' }}>Ibrahima NDIAYE</span>
            </div>

            <div>
              <strong style={{ color: 'var(--text-muted)', fontSize: '0.75rem', display: 'block' }}>EMAIL CONTACT DIRECT</strong>
            ...
            <div>
              <strong style={{ color: 'var(--text-muted)', fontSize: '0.75rem', display: 'block' }}>TÉLÉPHONE / WHATSAPP SUPPORT</strong>
              <a href="tel:+221778034756" style={{ fontWeight: 800, color: 'var(--text-main)', textDecoration: 'none' }}>
                +221 77 803 47 56
              </a>
            </div>
          </div>
        ...
        <div style={{ background: 'var(--bg-card)', padding: 24, borderRadius: 14, border: '1px solid var(--border-color)', display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10, fontSize: '0.85rem', color: 'var(--text-muted)' }}>
            <div>
              <strong style={{ color: 'var(--text-muted)', fontSize: '0.75rem', display: 'block' }}>VERSION APPLICATIVE</strong>
            ...
            <div>
              <strong style={{ color: 'var(--text-muted)', fontSize: '0.75rem', display: 'block' }}>TECHNOLOGIES CORE</strong>
              <span>NestJS 10, React 18, Vite 5, Prisma ORM, PostgreSQL, Docker & Nginx</span>
            </div>

            <div>
              <strong style={{ color: 'var(--text-muted)', fontSize: '0.75rem', display: 'block' }}>CONFORMITÉ FISCALE</strong>
              <span>TVA Optionnelle 18% UEMOA, NINEA / RCCM / IFU sur documents officiels</span>
            </div>

            <div>
              <strong style={{ color: 'var(--text-muted)', fontSize: '0.75rem', display: 'block' }}>SÉCURITÉ ET DONNÉES</strong>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>
        ...
        <div style={{ background: 'var(--bg-card)', padding: 24, borderRadius: 14, border: '1px solid var(--border-color)', display: 'flex', flexDirection: 'column', gap: 12 }}>
          <h3 style={{ margin: '0 0 4px 0', fontSize: '1.05rem', fontWeight: 800, color: 'var(--text-main)', display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8, fontSize: '0.85rem', marginTop: 4 }}>
            <div style={{ padding: '10px 12px', background: 'var(--bg-main)', borderRadius: 8, border: '1px solid #F3F4F6' }}>
              <strong style={{ color: 'var(--text-main)', display: 'block', fontSize: '0.78rem' }}>🟢 ASSISTANCE TÉLÉPHONIQUE & WHATSAPP</strong>
            ...
            <div style={{ padding: '10px 12px', background: 'var(--bg-main)', borderRadius: 8, border: '1px solid #F3F4F6' }}>
              <strong style={{ color: 'var(--text-main)', display: 'block', fontSize: '0.78rem' }}>✉️ SUPPORT TICKETING & EMAIL</strong>
            ...
            <div style={{ padding: '10px 12px', background: 'var(--bg-main)', borderRadius: 8, border: '1px solid #F3F4F6' }}>
              <strong style={{ color: 'var(--text-main)', display: 'block', fontSize: '0.78rem' }}>📍 BUREAU & ADRESSE ÉDITEUR</strong>
        ...
        <div style={{ background: 'var(--bg-card)', padding: 24, borderRadius: 14, border: '1px solid var(--border-color)', display: 'flex', flexDirection: 'column', gap: 12 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8, fontSize: '0.8rem', color: 'var(--text-muted)', lineHeight: 1.55 }}>
      ...
      <div style={{ background: 'var(--bg-main)', padding: 20, borderRadius: 12, border: '1px solid var(--border-color)', textAlign: 'center', fontSize: '0.82rem', color: 'var(--text-muted)' }}>
